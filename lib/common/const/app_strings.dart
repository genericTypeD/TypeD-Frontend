class AppStrings {
  ...
  /// 갤러리 권한
  static const String galleryPermissionTitle = '갤러리 접근 권한';
  static const String galleryPermissionContentPermanetlyDenied =
      '설정에서 갤러리 접근 권한을 허용해주세요.';
  static const String galleryPermissionContentInitially = '갤러리 접근 권한이 필요합니다.';
  static const String galleryPermissionAcceptButtonIfPermanetlyDenied =
      '설정으로 이동';
  static const String galleryPermissionAcceptButtonInitially = '권한 허용';

  /// 앱바
  static const String backButton = '뒤로 가기';
  static const String saveRecordButton = '기록';

  /// 기록 추가
  static const String emptyRecordDialogTitle = '기록이 비었습니다.';

  static const String cancelButton = '취소';
  static const String acceptButton = '확인';
}
